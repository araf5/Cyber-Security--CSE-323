<section class="panel">
    <header class="panel-heading" style="height: 35px">
        Keyword List <label class="panel-heading" style="margin-left: 75%"><i class="fa fa-plus-square-o" aria-hidden="true"></i>&nbsp;<a href="<?php echo ADMIN_PANEL_URL.'category/add_category'; ?>">Add Keyword</a></label>
...
<script type="text/javascript" charset="utf8" src="//cdn.datatables.net/1.10.11/js/jquery.dataTables.js"></script>
 <script type="text/javascript" language="javascript" >
     ...
     jQuery(document).ready(function() {
         ...
         var dataTable = jQuery("#"+table).DataTable( {
            ...
            "serverSide": true,"serverSide": true,
                    'aoColumnDefs': [{
                    'bSortable': false,
                    'aTargets': [0,1,3] /* 1st one, start by the right */
            }],
             "order": [[ 0, "desc" ]],
             "ajax":{
                 url :"$adminurl"+"category/ajax_categorys_list", // json datasource
    ...
    function block_category(id){
        ...
        jQuery.ajax({
            url:"$adminurl"+"category/ajax_block_category",
            type: "post",  // method  , by default get
            datatype:"json",
            data: {
                id: id,
    ...
    function delete_category(id){
        ...
        jQuery.ajax({
            url:"$adminurl"+"category/ajax_delete_category",
            type: "post",  // method  , by default get
            datatype:"json",
            data: {
                id: id,
