<section class="panel">
    <header class="panel-heading" style="height: 35px">
        Category List <label class="panel-heading" style="margin-left: 75%"><i class="fa fa-plus-square-o" aria-hidden="true"></i>&nbsp;<a href="<?php echo ADMIN_PANEL_URL.'news/add_news'; ?>">Add news</a></label>
...
<script type="text/javascript" charset="utf8" src="//cdn.datatables.net/1.10.11/js/jquery.dataTables.js"></script>
 <script type="text/javascript" language="javascript" >
     ...
     jQuery(document).ready(function() {
         ...
         var dataTable = jQuery("#"+table).DataTable( {
            ...
            "serverSide": true,"serverSide": true,
             ...
             "order": [[ 0, "desc" ]],
             "ajax":{
                 url :"$adminurl"+"news/ajax_news_list", // json datasource
    ...
    function block_feature(id){
        ...
        jQuery.ajax({
            url:"$adminurl"+"news/ajax_block_news",
            type: "post",  // method  , by default get
            dataType:"json",
            data: {
                id: id,
    ...
    function delete_feature(id){
        ...
        jQuery.ajax({
            url:"$adminurl"+"news/ajax_delete_news",
            type: "post",  // method  , by default get
            datatype:"json",
            data: {
                id: id,
