<section class="panel">
    <header class="panel-heading" style="height: 35px">
        Sub Services List <label class="panel-heading" style="margin-left: 70%"><i class="fa fa-plus-square-o" aria-hidden="true"></i>&nbsp;<a href="<?php echo ADMIN_PANEL_URL.'service/add_sub_service'; ?>">Add Sub Services</a></label>
            ...
            <table  class="display table table-bordered table-striped" id="backend-user-grid">
                ...
                <thead>
                    <tr>
                        ...
                        <th></th>
                        <th></th>
                        <th><select data-column="3" class="form-control search-input-text">
...
<script type="text/javascript" charset="utf8" src="//cdn.datatables.net/1.10.11/js/jquery.dataTables.js"></script>
 <script type="text/javascript" language="javascript" >
     ...
     jQuery(document).ready(function() {
         ...
         var dataTable = jQuery("#"+table).DataTable( {
            ...
            "serverSide": true,"serverSide": true,
                    'aoColumnDefs': [{
                    'bSortable': false,
                    'aTargets': [0,1,4,6] /* 1st one, start by the right */
            }],
             "order": [[ 0, "desc" ]],
             "ajax":{
                 url :"$adminurl"+"service/ajax_sub_services_list", // json datasource
    ...
    function block_sub_service(id){
        ...
        jQuery.ajax({
            url:"$adminurl"+"service/ajax_block_sub_service",
            type: "post",  // method  , by default get
            datatype:"json",
            data: {
                id: id,
    ...
    function delete_sub_service(id){
        ...
        jQuery.ajax({
            url:"$adminurl"+"service/ajax_delete_sub_service",
            type: "post",  // method  , by default get
            datatype:"json",
            data: {
                id: id,
