<section class="panel">
    <header class="panel-heading" style="height: 35px">
        Members List <label class="panel-heading" style="margin-left: 75%"><i class="fa fa-plus-square-o" aria-hidden="true"></i>&nbsp;<a href="<?php echo ADMIN_PANEL_URL.'team/add_team'; ?>">Add Team</a></label>
...
<script type="text/javascript" charset="utf8" src="//cdn.datatables.net/1.10.11/js/jquery.dataTables.js"></script>
 <script type="text/javascript" language="javascript" >
     ...
     jQuery(document).ready(function() {
         ...
         var dataTable = jQuery("#"+table).DataTable( {
            ...
            "serverSide": true,"serverSide": true,
                    'aoColumnDefs': [{
                    'bSortable': false,
                    'aTargets': [0,1,4,5] /* 1st one, start by the right */
            }],
             "order": [[ 0, "desc" ]],
             "ajax":{
                 url :"$adminurl"+"team/ajax_team_list", // json datasource
    ...
    function block_team(id){
        ...
        jQuery.ajax({
            url:"$adminurl"+"team/ajax_block_team",
            type: "post",  // method  , by default get
            datatype:"json",
            data: {
                id: id,
    ...
    function delete_team(id){
        ...
        jQuery.ajax({
            url:"$adminurl"+"team/ajax_delete_team",
            type: "post",  // method  , by default get
            datatype:"json",
            data: {
                id: id,
