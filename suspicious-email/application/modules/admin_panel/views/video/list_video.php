<section class="panel">
    <header class="panel-heading" style="height: 35px">
        Add Video <label class="panel-heading" style="margin-left: 75%"><i class="fa fa-plus-square-o" aria-hidden="true"></i>&nbsp;<a href="<?php echo ADMIN_PANEL_URL.'Video/add_video'; ?>">Add Video</a></label>
...
<script type="text/javascript" charset="utf8" src="//cdn.datatables.net/1.10.11/js/jquery.dataTables.js"></script>
 <script type="text/javascript" language="javascript" >
     ...
     jQuery(document).ready(function() {
         ...
         var dataTable = jQuery("#"+table).DataTable( {
            ...
            "serverSide": true,"serverSide": true,
                    'aoColumnDefs': [{
                    'bSortable': false,
                    'aTargets': [0,1,3,5] /* 1st one, start by the right */
            }],
             "order": [[ 0, "desc" ]],
             "ajax":{
                 url :"$adminurl"+"video/ajax_video_list", // json datasource
    ...
    function block_video(id){
        ...
        jQuery.ajax({
            url:"$adminurl"+"video/ajax_block_video",
            type: "post",  // method  , by default get
            datatype:"json",
            data: {
                id: id,
    ...
    function delete_video(id){
        ...
        jQuery.ajax({
            url:"$adminurl"+"about/ajax_delete_aboutus",
            type: "post",  // method  , by default get
            datatype:"json",
            data: {
                id: id,
