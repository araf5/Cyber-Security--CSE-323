...
<style>
   .content-top-breadcumcheckout {
    background: #000 url(<?php echo base_url('assets');?>/img/Checkout-min-hyper.jpg)repeat scroll 0 0;
    margin: 0px 0 30px;
    height: 156px;
    overflow: hidden;
...
<div class="content-top-breadcumcheckout">
</div>
	...
	<section id="do_action">
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-sm-6">
					<form action="<?php echo base_url()?>index.php/web_panel/checkout/place_order" method="post" >
						<div class="payment-options">
							<div class="order-message">
								<p class="alert alert-warning">Shipping Order</p>
								<?php echo $this->session->flashdata("flash_msg")?>
								<textarea name="payment_message"  placeholder="Notes about your order, Special Notes for Delivery" rows="4" cols="10"></textarea>
							</div>	
							<span>
