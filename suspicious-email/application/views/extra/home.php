...
<!--[if (gte IE 9)|!(IE)]><!--><html lang="en"> <!--<![endif]-->
    ...
    <!-- Mirrored from templatevisual.com/demo/learnplus/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Jun 2018 15:43:11 GMT -->
    <head>
        <meta charset="utf-8">
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>website_assets/css/A.carousel.css%2bbxslider.css%2cMcc.jgeTii-u52.css.pagespeed.cf.STKSIMl7GF.css"/>
    ...
    <body>
        <div id="loader">
            <div class="loader-container">
                <img src="<?php echo base_url(); ?>website_assets/images/site.gif" alt="" class="loader-site">
            </div>
        </div>
        <div id="wrapper">
            <div class="topbar">
                    ...
                    <div class="hovermenu ttmenu">
                        <div class="navbar navbar-default" role="navigation">
                            <div class="navbar-header">
                                ...
                                <div class="logo">
                                    <a class="navbar-brand" href="index.html"><img src="images/xlogo.png.pagespeed.ic.vap6Ukaf0i.png" alt=""></a>
                                </div>
                            </div>
                            <div class="navbar-collapse collapse">
                                                ...
                                                <div class="ttmenu-content">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-3 col-sm-6 nopadding">
                                                            <img class="img-thumbnail" src="<?php echo base_url(); ?>website_assets/upload/xservice_01.png.pagespeed.ic.2iuJZT3CaV.png" alt="">
                                                        </div>
                                                        <div class="col-md-3 col-sm-6 nopadding">
                                                            <img class="img-thumbnail" src="<?php echo base_url(); ?>website_assets/upload/xservice_02.png.pagespeed.ic.c6RThoxSWC.png" alt="">
                                                        </div>
                                                        <div class="col-md-3 col-sm-6 nopadding">
                                                            <img class="img-thumbnail" src="<?php echo base_url(); ?>website_assets/upload/xservice_03.png.pagespeed.ic.E_Ew4wn4ZP.png" alt="">
                                                        </div>
                                                        <div class="col-md-3 col-sm-6 nopadding">
                                                            <img class="img-thumbnail" src="<?php echo base_url(); ?>website_assets/upload/xservice_04.png.pagespeed.ic.NGi9jRXTXk.png" alt="">
                                                        </div>
                                                    </div>
                                                </div>
                                            </li>
                                ...
                                <ul class="nav navbar-nav navbar-right">
                                    <li><a class="btn btn-primary" href="<?php echo base_url('index.php/Student/index'); ?>"><i class="fa fa-sign-in"></i> Register Now</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="tp-banner">
                        <ul>
                            ...
                            <li data-transition="fade" data-slotamount="7" data-masterspeed="1500" data-delay="5000">
                                <img src="<?php echo base_url(); ?>website_assets/images/xdummy.png.pagespeed.ic.lRMfmktUso.png" alt="video_business" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat">
                                <div class="tp-caption tp-fade fadeout fullscreenvideo" data-x="0" data-y="0" data-speed="1000" data-start="800" data-easing="Power4.easeOut" data-endspeed="1500" data-endeasing="Power4.easeIn" data-autoplay="true" data-autoplayonlyfirsttime="false" data-nextslideatend="true" data-forceCover="1" data-aspectratio="16:9" data-forcerewind="on" style="z-index: 2"><video id="revvideo" class="video-js vjs-default-skin" preload="none" poster='images/dummy.png' data-setup="{}">
                                        <source src='<?php echo base_url(); ?>website_assets/upload/video.mp4' type='video/mp4'/>
                                        <source src='<?php echo base_url(); ?>website_assets/upload/video.webm' type='video/webm'/>
                                        <source src='<?php echo base_url(); ?>website_assets/upload/video.ogv' type='video/ogg'/>
                                    </video>
                                </div>
                            ...
                            <li data-transition="fade" data-slotamount="1" data-masterspeed="500" data-thumb="upload/slider_new_03.jpg" data-saveperformance="off" data-title="Slide">
                                <img src="<?php echo base_url(); ?>website_assets/upload/xslider_new_03.jpg.pagespeed.ic.0dDeZb1yS7.jpg" alt="fullslide1" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
                            ...
                            <li data-transition="fade" data-slotamount="1" data-masterspeed="500" data-thumb="upload/slider_new_02.jpg" data-saveperformance="off" data-title="Slide">
                                <img src="<?php echo base_url(); ?>website_assets/upload/xslider_new_02.jpg.pagespeed.ic.QHr4wT-HDB.jpg" alt="fullslide1" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
                    ...
                    <div id="owl-featured" class="owl-custom">
                        <div class="owl-featured">
                            <div class="shop-item-list entry">
                                <div class="">
                                    <img src="<?php echo base_url(); ?>website_assets/upload/xcourse_01.png.pagespeed.ic.XTOvCuUmZu.png" alt="">
                                    <div class="magnifier">
                                    </div>
                                </div>
                                <div class="shop-item-title clearfix">
                                    <h4><a href="<?php echo base_url(); ?>website_assets/course-single.html">Learn Web Design & Development</a></h4>
                                    <div class="shopmeta">
                        ...
                        <div class="owl-featured">
                            <div class="shop-item-list entry">
                                <div class="">
                                    <img src="<?php echo base_url(); ?>website_assets/upload/xcourse_02.png.pagespeed.ic.PL7Wu2UcSB.png" alt="">
                                    <div class="magnifier">
                                    </div>
                                </div>
                                <div class="shop-item-title clearfix">
                                    <h4><a href="<?php echo base_url(); ?>website_assets/course-single.html">Graphic Design & Logo Mockups Course</a></h4>
                                    <div class="shopmeta">
                        ...
                        <div class="owl-featured">
                            <div class="shop-item-list entry">
                                <div class="">
                                    <img src="<?php echo base_url(); ?>website_assets/upload/xcourse_03.png.pagespeed.ic.8e1MyY5M7i.png" alt="">
                                    <div class="magnifier">
                                    </div>
                                </div>
                                <div class="shop-item-title clearfix">
                                    <h4><a href="<?php echo base_url(); ?>website_assets/course-single.html">Social Media Network & Marketing</a></h4>
                                    <div class="shopmeta">
                        ...
                        <div class="owl-featured">
                            <div class="shop-item-list entry">
                                <div class="">
                                    <img src="<?php echo base_url(); ?>website_assets/upload/xcourse_04.png.pagespeed.ic.2rIKmUwjA7.png" alt="">
                                    <div class="magnifier">
                                    </div>
                                </div>
                                <div class="shop-item-title clearfix">
                                    <h4><a href="<?php echo base_url(); ?>website_assets/course-single.html">WordPress Blogging, Tumblr and Blogger</a></h4>
                                    <div class="shopmeta">
                                        <span class="pull-left">98 Student</span>
                                        <div class="rating pull-right">
                                            <i class="fa fa-star"></i>
                                ...
                                <div class="visible-buttons">
                                    <a title="Add to Cart" href="<?php echo base_url(); ?>website_assets/page-shop-cart.html"><span class="fa fa-cart-arrow-down"></span></a>
                                    <a title="Read More" href="<?php echo base_url(); ?>website_assets/course-single.html"><span class="fa fa-search"></span></a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section class="section darkskin fullscreen paralbackground parallax" style="background-image:url(<?php echo base_url(); ?>website_assets/upload/xparallax_01.jpg.pagespeed.ic.JPVsQrTu6o.jpg)" data-img-width="1627" data-img-height="868" data-diff="100">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="image-center wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                                <img src="<?php echo base_url(); ?>website_assets/upload/xdevice_02.png.pagespeed.ic.w5TutKGgkN.png" alt="" class="img-responsive">
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-6">
                            ...
                            <div class="content-widget">
                                <div class="team-members row">
                                    <div class="col-md-3 col-sm-6 col-xs-12">
                                        <div class="team">
                                            <img src="<?php echo base_url(); ?>website_assets/upload/xteam_01.jpg.pagespeed.ic.uNKwi9Xmie.jpg" alt="" class="img-responsive wow fadeInUp">
                                    ...
                                    <div class="col-md-3 col-sm-6 col-xs-12">
                                        <div class="team">
                                            <img src="<?php echo base_url(); ?>website_assets/upload/xteam_02.jpg.pagespeed.ic.Foo3PN64df.jpg" alt="" class="img-responsive wow fadeInUp">
                                            <div class="team-hover-content">
                                                <h5>Adam DEO</h5>
                                    ...
                                    <div class="col-md-3 col-sm-6 col-xs-12">
                                        <div class="team">
                                            <img src="<?php echo base_url(); ?>website_assets/upload/xteam_03.jpg.pagespeed.ic.Mw22RnI1eL.jpg" alt="" class="img-responsive wow fadeInUp">
                                            <div class="team-hover-content">
                                                <h5>Jenny Kennedy</h5>
                                    ...
                                    <div class="col-md-3 col-sm-6 col-xs-12">
                                        <div class="team">
                                            <img src="<?php echo base_url(); ?>website_assets/upload/xteam_04.jpg.pagespeed.ic.equz9NTtM1.jpg" alt="" class="img-responsive wow fadeInUp">
                                            <div class="team-hover-content">
                                                <h5>Jennifer DEO</h5>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="blog-wrapper">
                                <div class="blog-title">
                                    ...
                                    <h2><a href="<?php echo base_url(); ?>website_assets/single.html" title="">Best Learning Management System for Ever</a></h2>
                                    <div class="post-meta">
                                        <span>
                                ...
                                <div class="blog-image">
                                    <a href="<?php echo base_url(); ?>website_assets/single.html" title=""><img src="<?php echo base_url(); ?>website_assets/upload/xblog_01.jpg.pagespeed.ic.2jVY1j1OMe.jpg" alt="" class="img-responsive"></a>
                                </div>
                                <div class="blog-desc">
                                    ...
                                    <a href="<?php echo base_url(); ?>website_assets/single.html" class="btn btn-default btn-block">Read More</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-6">
                            <div class="blog-wrapper">
                                <div class="blog-title">
                                    ...
                                    <h2><a href="<?php echo base_url(); ?>website_assets/single.html" title="">Best SEO Google System and Algoritmas</a></h2>
                                    <div class="post-meta">
                                        <span>
                                            <i class="fa fa-user"></i>
                                            <a href="#">Jenny</a>
                                ...
                                <div class="blog-image">
                                    <a href="<?php echo base_url(); ?>website_assets/single.html" title=""><img src="<?php echo base_url(); ?>website_assets/upload/xblog_02.jpg.pagespeed.ic.VhhhBexs2E.jpg" alt="" class="img-responsive"></a>
                                </div>
                                <div class="blog-desc">
                                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since theown printer took.</p>
                                    <a href="<?php echo base_url(); ?>website_assets/single.html" class="btn btn-default btn-block">Read More</a>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="blog-wrapper">
                                <div class="blog-title">
                                    ...
                                    <h2><a href="<?php echo base_url(); ?>website_assets/single.html" title="">Never Forget! WooCommerce is an Amazing Plugin</a></h2>
                                    <div class="post-meta">
                                        <span>
                                            <i class="fa fa-user"></i>
                                            <a href="#">Bob Doe</a>
                                ...
                                <div class="blog-image">
                                    <a href="<?php echo base_url(); ?>website_assets/single.html" title=""><img src="<?php echo base_url(); ?>website_assets/upload/xblog_03.jpg.pagespeed.ic.ZGQLz9XvWC.jpg" alt="" class="img-responsive"></a>
                                </div>
                                <div class="blog-desc">
                                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since theown printer took.</p>
                                    <a href="<?php echo base_url(); ?>website_assets/single.html" class="btn btn-default btn-block">Read More</a>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            <div class="testimonial">
                                <img class="alignleft img-circle" src="<?php echo base_url(); ?>website_assets/upload/xstudent_01.png.pagespeed.ic.756JwMcqdq.png" alt="">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            <div class="testimonial">
                                <img class="alignleft img-circle" src="<?php echo base_url(); ?>website_assets/upload/xstudent_02.png.pagespeed.ic.y-PM-y4pVj.png" alt="">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            <div class="testimonial">
                                <img class="alignleft img-circle" src="<?php echo base_url(); ?>website_assets/upload/xstudent_03.png.pagespeed.ic.uCQY3WNMCJ.png" alt="">
            ...
            <section class="grey section">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <img src="<?php echo base_url(); ?>website_assets/upload/xclient_01.png.pagespeed.ic.m5NnlxSzhM.png" alt="" class="img-responsive img-thumbnail">
                        </div>
                        <div class="col-md-2">
                            <img src="<?php echo base_url(); ?>website_assets/upload/xclient_02.png.pagespeed.ic.BsH9V4BqCi.png" alt="" class="img-responsive img-thumbnail">
                        </div>
                        <div class="col-md-2">
                            <img src="<?php echo base_url(); ?>website_assets/upload/xclient_03.png.pagespeed.ic.mxzQrepbL_.png" alt="" class="img-responsive img-thumbnail">
                        </div>
                        <div class="col-md-2">
                            <img src="<?php echo base_url(); ?>website_assets/upload/xclient_04.png.pagespeed.ic.Fx2ObIy0Eb.png" alt="" class="img-responsive img-thumbnail">
                        </div>
                        <div class="col-md-2">
                            <img src="<?php echo base_url(); ?>website_assets/upload/xclient_05.png.pagespeed.ic.GBNy2ra72B.png" alt="" class="img-responsive img-thumbnail">
                        </div>
                        <div class="col-md-2">
                            <img src="<?php echo base_url(); ?>website_assets/upload/xclient_06.png.pagespeed.ic.a_uqmnbFy0.png" alt="" class="img-responsive img-thumbnail">
                        </div>
                    </div>
                </div>
            </section>
                        ...
                        <div class="col-md-3 col-md-6 col-xs-12">
                            <div class="widget">
                                ...
                                <ul class="popular-courses">
                                    <li>
                                        <a href="<?php echo base_url(); ?>website_assets/single-course.html" title=""><img class="img-thumbnail" src="<?php echo base_url(); ?>website_assets/upload/xservice_01.png.pagespeed.ic.2iuJZT3CaV.png" alt=""></a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>website_assets/single-course.html" title=""><img class="img-thumbnail" src="<?php echo base_url(); ?>website_assets/upload/xservice_02.png.pagespeed.ic.c6RThoxSWC.png" alt=""></a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>website_assets/single-course.html" title=""><img class="img-thumbnail" src="<?php echo base_url(); ?>website_assets/upload/xservice_03.png.pagespeed.ic.E_Ew4wn4ZP.png" alt=""></a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>website_assets/single-course.html" title=""><img class="img-thumbnail" src="<?php echo base_url(); ?>website_assets/upload/xservice_04.png.pagespeed.ic.NGi9jRXTXk.png" alt=""></a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>website_assets/single-course.html" title=""><img class="img-thumbnail" src="<?php echo base_url(); ?>website_assets/upload/xservice_05.png.pagespeed.ic.2iuJZT3CaV.png" alt=""></a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>website_assets/single-course.html" title=""><img class="img-thumbnail" src="<?php echo base_url(); ?>website_assets/upload/xservice_06.png.pagespeed.ic.o2Uniwq-y5.png" alt=""></a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>website_assets/single-course.html" title=""><img class="img-thumbnail" src="<?php echo base_url(); ?>website_assets/upload/xservice_07.png.pagespeed.ic.H-fRTeeP8u.png" alt=""></a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>website_assets/single-course.html" title=""><img class="img-thumbnail" src="<?php echo base_url(); ?>website_assets/upload/xservice_08.png.pagespeed.ic.76ek5JLaEY.png" alt=""></a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>website_assets/single-course.html" title=""><img class="img-thumbnail" src="<?php echo base_url(); ?>website_assets/upload/xservice_09.png.pagespeed.ic.FJcG938KC-.png" alt=""></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
        ...
        <script src="<?php echo base_url(); ?>website_assets/rs-plugin/js/jquery.themepunch.tools.min.js.pagespeed.jm.0PLSBOOLZa.js"></script>
        <script src="<?php echo base_url(); ?>website_assets/rs-plugin/js/jquery.themepunch.revolution.min.js"></script>
        <script>jQuery(document).ready(function () {
                jQuery('.tp-banner').show().revolution({dottedOverlay: "none", delay: 16000, startwidth: 1170, startheight: 620, hideThumbs: 200, thumbWidth: 100, thumbHeight: 50, thumbAmount: 5, navigationType: "none", navigationArrows: "solo", navigationStyle: "preview3", touchenabled: "on", onHoverStop: "on", swipe_velocity: 0.7, swipe_min_touches: 1, swipe_max_touches: 1, drag_block_vertical: false, parallax: "mouse", parallaxBgFreeze: "on", parallaxLevels: [10, 7, 4, 3, 2, 5, 4, 3, 2, 1], parallaxDisableOnMobile: "off", keyboardNavigation: "off", navigationHAlign: "center", navigationVAlign: "bottom", navigationHOffset: 0, navigationVOffset: 20, soloArrowLeftHalign: "left", soloArrowLeftValign: "center", soloArrowLeftHOffset: 20, soloArrowLeftVOffset: 0, soloArrowRightHalign: "right", soloArrowRightValign: "center", soloArrowRightHOffset: 20, soloArrowRightVOffset: 0, shadow: 0, fullWidth: "on", fullScreen: "off", spinner: "spinner4", stopLoop: "off", stopAfterLoops: -1, stopAtSlide: -1, shuffle: "off", autoHeight: "off", forceFullWidth: "off", hideThumbsOnMobile: "off", hideNavDelayOnMobile: 1500, hideBulletsOnMobile: "off", hideArrowsOnMobile: "off", hideThumbsUnderResolution: 0, hideSliderAtLimit: 0, hideCaptionAtLimit: 0, hideAllCaptionAtLilmit: 0, startWithSlide: 0, fullScreenOffsetContainer: ""});
            });</script>
        <script src="<?php echo base_url(); ?>website_assets/js/bxslider.js.pagespeed.jm.X-sF7YFq4Y.js"></script>
        <script type="<?php echo base_url(); ?>website_assets/text/javascript">(function($){"use strict";$('.bxslider').bxSlider({mode:'vertical',minSlides:1,maxSlides:1,slideMargin:0,pager:false,nextText:'<i class="fa fa-arrow-down"></i>',prevText:'<i class="fa fa-arrow-up"></i>',speed:1000,auto:true});})(jQuery);</script>
    </body>

    <!-- Mirrored from templatevisual.com/demo/learnplus/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Jun 2018 15:47:47 GMT -->
</html>